...
interface Props {
  ...
  totalHT?: number;
  /** Marge revendeur estimée (retail TTC - achat HT) */
...
const ProTierBar = ({
  ...
  const coef = hasData && totalHT > 0 ? retailTotalTTC / totalHT : 0;
  const marginPct = retailTotalTTC > 0 ? (resellerMarginTotal / retailTotalTTC) * 100 : 0;
