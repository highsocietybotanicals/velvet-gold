...
const groupB: Product[] = [
  ...
  },
  {
    ...
    badge: "Élixir Noir 50%",
    description: "Collection Rare Indoor. Arômes de mangue et notes tropicales uniques, enrichie à 50% d'Élixir Noir.",
    price: 13,
    priceGroup: "B",
    cbdPercentage: "50% Élixir Noir",
    molecule: "10-OH+",
...
const topRange: Product[] = [
  {
    ...
    name: "Bubble Hash Maturer",
    subtitle: "Résine Exotique",
    badge: "Exotique",
    description: "Résine Exotique à la teinte crème et à la texture compacte et délicatement friable, présentée dans sa forme véritable.",
    price: 16,
    priceGroup: "B",
    cbdPercentage: "24% HE",
    molecule: "HE",
  ...
  },
  {
    ...
    badge: "Force Noire",
    description: "Résine Force Noire à la robe claire et à la texture sèche, poudreuse et friable, présentée dans sa forme véritable.",
    price: 11,
    priceGroup: "B",
    cbdPercentage: "12% HE",
    molecule: "HE",
...
// Tri : gamme Exotique toujours en tête
const exotiqueFirst = (list: Product[]): Product[] => [
  ...list.filter((p) => p.isExotique),
  ...list.filter((p) => !p.isExotique),
];
