...
const groupB: Product[] = [
  {
    ...
    description: "Edition Limitée Indoor. La puissance à l'état pur avec 50% de concentration.",
    price: 14,
    priceGroup: "B",
    cbdPercentage: "50%",
    image: nineOneOne,
  ...
  },
  {
    ...
    badge: "Rare 10-OH+",
    description: "Collection Rare Indoor 30%. Arômes de mangue et notes tropicales uniques.",
    price: 14,
    priceGroup: "B",
    cbdPercentage: "30%",
    image: blueMango,
